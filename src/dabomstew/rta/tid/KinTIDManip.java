...
public class KinTIDManip {
    ...
    static {
        ...
        int introScene3Addr;
        int titleScreenAddr;
        //if(gameName.equals("kin")) {
            introScene0Addr = KinAddr.kinIntroScene0Addr;
            introScene1Addr = KinAddr.kinIntroScene1Addr;
            introScene2Addr = KinAddr.kinIntroScene2Addr;
            introScene3Addr = KinAddr.kinIntroScene3Addr;
            titleScreenAddr = KinAddr.kinTitleScreenAddr;
        //}
        /*else {
            introScene0Addr = KinAddr.silverIntroScene0Addr;
            introScene1Addr = KinAddr.silverIntroScene1Addr;
            introScene2Addr = KinAddr.silverIntroScene2Addr;
            introScene3Addr = KinAddr.silverIntroScene3Addr;
            titleScreenAddr = KinAddr.silverTitleScreenAddr;
        }*/

        Strat gfSkip = new Strat("_gfskip", 0, new Integer[]{KinAddr.readJoypadAddr}, new Integer[]{START}, new Integer[]{1});
        Strat gfWait = new Strat("_gfwait", 332, new Integer[]{introScene0Addr, KinAddr.readJoypadAddr}, new Integer[]{NO_INPUT, START}, new Integer[]{0, 1});
        Strat intro0 = new Strat("_intro0", 344, new Integer[]{introScene1Addr, KinAddr.readJoypadAddr}, new Integer[]{NO_INPUT, START}, new Integer[]{0, 1});
        Strat intro1 = new Strat("_intro1", 1830, new Integer[]{introScene2Addr, KinAddr.readJoypadAddr}, new Integer[]{NO_INPUT, START}, new Integer[]{0, 1});
        Strat intro2 = new Strat("_intro2", 2290, new Integer[]{introScene3Addr, KinAddr.readJoypadAddr}, new Integer[]{NO_INPUT, START}, new Integer[]{0, 1});
        ...
        newGame = new Strat("_newgame", 8, new Integer[] {KinAddr.readJoypadAddr}, new Integer[] {A}, new Integer[] {16});
        backout = new Strat("_backout", 16, new Integer[] {KinAddr.readJoypadAddr}, new Integer[] {B}, new Integer[] {1});
    ...
    private static int readTID(Gb gb) {
        return (gb.readMemory(0xD1B3) << 8) | gb.readMemory(0xD1B4);
    }

    private static int readLID(Gb gb) {
        return (gb.readMemory(0xD9AF) << 8) | gb.readMemory(0xD9B0);
    }
}