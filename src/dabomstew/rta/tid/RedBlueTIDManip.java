...
public class RedBlueTIDManip {
    ...
    private static Strat nido1 = new Strat("_hop1", 172 + 131 + TITLE_BASE_COST, new Integer[] {RedBlueAddr.animateNidorinoAddr, RedBlueAddr.checkInterruptAddr, RedBlueAddr.joypadAddr}, new Integer[] {NO_INPUT, NO_INPUT, UP | SELECT | B}, new Integer[] {0, 0, 1});
    private static Strat nido2 = new Strat("_hop2", 172 + 190 + TITLE_BASE_COST, new Integer[] {RedBlueAddr.animateNidorinoAddr, RedBlueAddr.checkInterruptAddr, RedBlueAddr.animateNidorinoAddr, RedBlueAddr.checkInterruptAddr, RedBlueAddr.joypadAddr}, new Integer[] {NO_INPUT, NO_INPUT, NO_INPUT, NO_INPUT, UP | SELECT | B}, new Integer[] {0, 0, 0, 0, 1});
